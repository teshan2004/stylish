...
"""
    ...
    buttons = [
        [
            InlineKeyboardButton('👥 Group', url=f"https://t.me/techeradiscussion"),
            InlineKeyboardButton('Channel 📢', url=f"https://t.me/techeralk")
            ],[
            InlineKeyboardButton('Report Bugs ⚙️', url=f"https://t.me/{owner_username}"),
            ],[
            InlineKeyboardButton('⚜️ Subscribe Now YouTube ⚜️', url=f"https://www.youtube.com/c/TechEraLK")
        ]
    ]
    await m.reply_text(
        text=text,
